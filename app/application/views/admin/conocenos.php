     ...
     <div class="modal-dialog  modal-xl">
         <div class="modal-content">
             <div class="modal-header">
                 <h1 class="modal-title fs-5 text-dark" id="exampleModalLabel">Borrar Imagen Conocenos</h1>
 ...
 <div class="modal fade" id="agrega_img_conocenos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form id="form_carrga_img" method="POST" enctype="multipart/form-data">
