            ...
            <div class="row">
                ...
                <div class="col-md-55">
                    <div class="card text-center">
                        <button style="width: 40px mt-4;" data-bs-toggle="modal" data-bs-target="#modal_img_portafolio" class="btn btn-warning btn-block"><i class="bi bi-pencil-square"></i></button>
                        <div class="card-header">
                            Cargar Imagen Portafolio 
                        </div>
                ...
                <div class="row justify-content-center mt-4" id="img_portafolio">
                </div>
            </div>
        </div><!--/row-->
    </section><!--/conocenos-->
